...
public class WorldDataActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_world_date);
        ...
        swipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                ...
                Toast.makeText(WorldDataActivity.this, "Status Refreshed!", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void Init() {
        tv_confirmed = findViewById(R.id.activity_world_date_confirmed_textView);
        tv_confirmed_new = findViewById(R.id.activity_world_date_confirmed_new_textView);
        tv_active = findViewById(R.id.activity_world_date_active_textView);
        tv_active_new = findViewById(R.id.activity_world_date_active_new_textView);
        tv_recovered = findViewById(R.id.activity_world_date_recovered_textView);
        tv_recovered_new = findViewById(R.id.activity_world_date_recovered_new_textView);
        tv_death = findViewById(R.id.activity_world_date_death_textView);
        tv_death_new = findViewById(R.id.activity_world_date_death_new_textView);
        tv_tests = findViewById(R.id.activity_world_date_tests_textView);
        swipeRefreshLayout = findViewById(R.id.activity_world_date_swipe_refresh_layout);
        pieChart = findViewById(R.id.activity_world_date_piechart);
        lin_countrywise = findViewById(R.id.activity_world_date_countrywise_lin);
    }
    @Override
