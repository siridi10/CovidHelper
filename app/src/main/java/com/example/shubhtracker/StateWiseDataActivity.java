...
import com.example.shubhtracker.Adpaters.StateWiseAdapter;
...
public class StateWiseDataActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_state_wise_date);
        ...
        swipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                ...
                Toast.makeText(StateWiseDataActivity.this, "Status Refreshed!", Toast.LENGTH_SHORT).show();
            }
        });
